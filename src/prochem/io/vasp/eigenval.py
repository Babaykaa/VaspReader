...
from prochem.io.vasp.common import VASPfileType, numbers_from_line, read_nonempty_lines
...
def read_eigenval(source: Path, file_type: VASPfileType = VASPfileType.EIGENVAL, engine: str = "vasp") -> Calculation:
    ...
    if len(lines) < 7:
        return _error_calculation(source, engine, "EIGENVAL file is too short.")
